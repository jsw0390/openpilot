...
window.CarrotTranslations.register("ko", {
  ...
  strings: {
    ...
    mapd_maps: "OSM 지도",
    mapd_download_korea: "한국 지도",
    mapd_download_custom: "지도 선택",
    mapd_status: "지도 상태",
    mapd_cancel: "다운로드 취소",
    mapd_enabled: "Mapd 사용",
    mapd_process: "Mapd 프로세스",
    mapd_download: "다운로드",
    mapd_progress: "진행률",
    mapd_locations: "지역",
    ...
    mapd_area_japan: "일본",
    mapd_area_us: "미국",
    mapd_area_custom: "직접 입력",
    mapd_download_confirm: "OSM 지도 데이터를 다운로드할까요?\n\n{label}",
    mapd_select_prompt: "다운로드할 지도 지역을 선택하세요.",
    mapd_custom_prompt: "mapd 다운로드 경로를 입력하세요.\n예: nation.KR",
    mapd_cancel_confirm: "현재 지도 다운로드를 취소할까요?",
    enable: "활성화",
  ...
  actionLabels: {
    ...
    mapd_download: { running: "지도 다운로드 중...", done: "지도 다운로드 완료", failed: "지도 다운로드 실패" },
    mapd_cancel_download: { running: "지도 다운로드 취소 중...", done: "취소 요청 완료", failed: "취소 실패" },
    mapd_status: { running: "지도 상태 확인 중...", done: "지도 상태 확인 완료", failed: "지도 상태 확인 실패" },
  ...
  errorMessages: {
    ...
    MAPD_DOWNLOAD_CANCELLED: () => "지도 다운로드가 취소되었습니다",
  },
