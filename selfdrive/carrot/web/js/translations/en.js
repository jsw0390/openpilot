...
window.CarrotTranslations.register("en", {
  ...
  strings: {
    ...
    mapd_maps: "OSM Maps",
    mapd_download_korea: "Korea map",
    mapd_download_custom: "choose map",
    mapd_status: "map status",
    mapd_cancel: "cancel download",
    mapd_enabled: "Mapd enabled",
    mapd_process: "Mapd process",
    ...
    mapd_area_japan: "Japan",
    mapd_area_us: "United States",
    mapd_area_custom: "Custom path",
    mapd_download_confirm: "Download OSM map data?\n\n{label}",
    mapd_select_prompt: "Select a map area to download.",
    mapd_custom_prompt: "Enter mapd download path.\nExample: nation.KR",
    mapd_cancel_confirm: "Cancel the current map download?",
    enable: "Enable",
  ...
  actionLabels: {
    ...
    mapd_download:    { running: "Downloading map...",       done: "Map download complete", failed: "Map download failed" },
    mapd_cancel_download: { running: "Cancelling map download...", done: "Cancel requested", failed: "Cancel failed" },
    mapd_status:      { running: "Reading map status...",    done: "Map status loaded",    failed: "Map status failed" },
  ...
  errorMessages: {
    ...
    MAPD_DOWNLOAD_CANCELLED: () => "Map download was cancelled",
  },
