...
window.CarrotTranslations.register("zh", {
  ...
  strings: {
    ...
    mapd_maps: "OSM 地图",
    mapd_download_korea: "韩国地图",
    mapd_download_custom: "选择地图",
    mapd_status: "地图状态",
    mapd_cancel: "取消下载",
    mapd_enabled: "Mapd 启用",
    mapd_process: "Mapd 进程",
    mapd_download: "下载",
    mapd_progress: "进度",
    mapd_locations: "地区",
    ...
    mapd_area_japan: "日本",
    mapd_area_us: "美国",
    mapd_area_custom: "自定义路径",
    mapd_download_confirm: "下载 OSM 地图数据？\n\n{label}",
    mapd_select_prompt: "选择要下载的地图区域。",
    mapd_custom_prompt: "输入 mapd 下载路径。\n示例: nation.KR",
    mapd_cancel_confirm: "取消当前地图下载？",
  ...
  actionLabels: {
    ...
    mapd_download: { running: "正在下载地图...", done: "地图下载完成", failed: "地图下载失败" },
    mapd_cancel_download: { running: "正在取消地图下载...", done: "取消请求已发送", failed: "取消失败" },
    mapd_status: { running: "正在读取地图状态...", done: "地图状态已读取", failed: "地图状态失败" },
  ...
  errorMessages: {
    ...
    MAPD_DOWNLOAD_CANCELLED: () => "地图下载已取消",
  },
