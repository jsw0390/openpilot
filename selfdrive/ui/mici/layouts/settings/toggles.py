...
class TogglesLayoutMici(NavScroller):
  def __init__(self):
    ...
    steer_saturated_sound_toggle = BigParamControl("steer limit exceeded sound", "SteerSaturatedSound")
    ...
    self._refresh_toggles = (
      ...
      ("SteerSaturatedSound", steer_saturated_sound_toggle),
